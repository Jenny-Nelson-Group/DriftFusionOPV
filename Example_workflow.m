...
offset                      = 0.17;                 % eV    % energy difference between the excited state and the CT state
...
kdisEx      = 8e9;      % Rate Constatn Ex dissociation     % 1 / s
kdisCT      = 1.2e9;    % Rate Constant CT dissociation     % 1 / s
